...
public class DetailTvActivity extends AppCompatActivity {
    public static final String EXTRATVSHOW = "extra_tv";
    @BindView(R.id.iv_imagetv)
    ImageView ivImage;
    @BindView(R.id.tv_titletv)
    TextView tvDetailJudul;
    @BindView(R.id.tv_genretv)
    TextView tvDetailGenre;
    @BindView(R.id.tv_release_datetv)
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        ResultsMovie resultsItemMovie = getIntent().getParcelableExtra(EXTRATVSHOW);
    ...
    private void setUpDelay() {
        new Handler().postDelayed(() -> {
            ...
            Glide.with(DetailTvActivity.this).load(BuildConfig.BASE_URL_IMAGE + resultsItemMovie.getBackdropPath()).into(ivImage);
